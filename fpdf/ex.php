...
<html lang="en" class="">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>fpdf/ex.php at master · lsolesen/fpdf · GitHub</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars2.githubusercontent.com/u/148026?v=3&amp;s=400" property="og:image" /><meta content="lsolesen/fpdf" property="og:title" /><meta content="https://github.com/lsolesen/fpdf" property="og:url" /><meta content="fpdf - [Unofficial] FPDF Library. Pdf Generator." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="4DC69110:7FA4:B8F439:54C8AACE" name="octolytics-dimension-request_id" />
...
<meta content="rRSU98eNfcauUkBdE1ce/SKTq/7J04Weji9bdVEuzuD1aVgrsV2L1oeF7eqkruwuZiYu79hw5YaStoZfngULeA==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions" role="navigation">
      ...
      <a class="button" href="/login?return_to=%2Flsolesen%2Ffpdf%2Fblob%2Fmaster%2Fexamples%2Fprotection%2Fex.php" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
    </div>
...
<a href="/lsolesen/fpdf/blob/f321be9320d7a4a67c9b27a5e1ad576d75af3714/examples/protection/ex.php" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:f3396f68cb6c465818ff9f612f015453 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              ...
              <a href="/lsolesen/fpdf/blob/master/examples/protection/ex.php"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/lsolesen/fpdf/tree/1.6.0/examples/protection/ex.php"
                 data-name="1.6.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
...
<div class="file-box">
    ...
    <div class="meta clearfix">
      ...
      <div class="actions">
        <div class="button-group">
          <a href="/lsolesen/fpdf/raw/master/examples/protection/ex.php" class="minibutton " id="raw-url">Raw</a>
            <a href="/lsolesen/fpdf/blame/master/examples/protection/ex.php" class="minibutton js-update-url-with-hash">Blame</a>
          <a href="/lsolesen/fpdf/commits/master/examples/protection/ex.php" class="minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
  ...
  <div class="blob-wrapper data type-php">
      ...
      <tr>
        ...
        <td id="LC2" class="blob-code js-file-line"><span class="pl-s2"><span class="pl-k">require</span>(<span class="pl-s1"><span class="pl-pds">&#39;</span>fpdf_protection.php<span class="pl-pds">&#39;</span></span>);</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC4" class="blob-code js-file-line"><span class="pl-s2"><span class="pl-vo">$pdf</span><span class="pl-k">=</span><span class="pl-k">new</span> <span class="pl-s3">FPDF_Protection</span>();</span></td>
      </tr>
      <tr>
        <td id="L5" class="blob-num js-line-number" data-line-number="5"></td>
        <td id="LC5" class="blob-code js-file-line"><span class="pl-s2"><span class="pl-vo">$pdf</span><span class="pl-k">-&gt;</span>SetProtection(<span class="pl-s3">array</span>(<span class="pl-s1"><span class="pl-pds">&#39;</span>print<span class="pl-pds">&#39;</span></span>));</span></td>
      </tr>
      <tr>
        <td id="L6" class="blob-num js-line-number" data-line-number="6"></td>
        <td id="LC6" class="blob-code js-file-line"><span class="pl-s2"><span class="pl-vo">$pdf</span><span class="pl-k">-&gt;</span>AddPage();</span></td>
      </tr>
      <tr>
        <td id="L7" class="blob-num js-line-number" data-line-number="7"></td>
        <td id="LC7" class="blob-code js-file-line"><span class="pl-s2"><span class="pl-vo">$pdf</span><span class="pl-k">-&gt;</span>SetFont(<span class="pl-s1"><span class="pl-pds">&#39;</span>Arial<span class="pl-pds">&#39;</span></span>);</span></td>
      </tr>
      <tr>
        <td id="L8" class="blob-num js-line-number" data-line-number="8"></td>
        <td id="LC8" class="blob-code js-file-line"><span class="pl-s2"><span class="pl-vo">$pdf</span><span class="pl-k">-&gt;</span>Write(<span class="pl-c1">10</span>,<span class="pl-s1"><span class="pl-pds">&#39;</span>You can print me but not copy my text.<span class="pl-pds">&#39;</span></span>);</span></td>
      </tr>
      <tr>
        <td id="L9" class="blob-num js-line-number" data-line-number="9"></td>
        <td id="LC9" class="blob-code js-file-line"><span class="pl-s2"><span class="pl-vo">$pdf</span><span class="pl-k">-&gt;</span>Output();</span></td>
      </tr>
      <tr>
        <td id="L10" class="blob-num js-line-number" data-line-number="10"></td>
        <td id="LC10" class="blob-code js-file-line"><span class="pl-s2"></span><span class="pl-pse"><span class="pl-s2">?</span>&gt;</span></td>
      </tr>
</table>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2015 <span title="0.02557s from github-fe117-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
